...
$s_masuk 	= $this->db->query("SELECT * FROM surat_masuk_keluar WHERE status='masuk'")->num_rows();
$s_keluar 	= $this->db->query("SELECT * FROM surat_masuk_keluar WHERE status='keluar'")->num_rows();
$karyawan	= $this->db->query("SELECT * FROM karyawan WHERE status_aktif='1'")->num_rows();
$pelatihan 	= $this->db->get("pelatihan")->num_rows();


//$peserta 	= $this->db->query("SELECT COUNT (*) FROM peserta")->num_rows();
...
<div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url('surat_keluar/tahun/2019')?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
