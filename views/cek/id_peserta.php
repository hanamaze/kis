...
/*# sourceMappingURL=Searchs_130.css.map */
  ...
  <body style="background:url('<?php echo base_url();?>gambar/Searchs_006.png');">
  <center>
  <h2 style="color:white;">Cek Data Peserta Pelatihan</h2>
  <p style="color:white;">PT. Kualitas Indonesia Sistem</p>
	</center>
    <div class="s130">
	<?php $cekk = $this->db->query("SELECT * FROM setting WHERE id_setting='1' AND status='1'")->row();
		  if($cekk != NULL){
		  ?>
      <form method="POST">
        <div class="inner-form">
          <div class="input-field first-wrap">
            ...
            <input id="search" type="text" name="kode" placeholder="Masukan ID Anda..." />
          </div>
		  
          <div class="input-field second-wrap">
            <button style="background-color:yellow; color:black;" class="btn-search" type="submit">Cari</button>
          </div>
		  </div>
		   <?php
	  ...
	  <?php
			  ...
			  echo "<h1 style='color:white;'>Tidak Bisa Diakses, Hubungi Panitia/Web Master</h1>";
		  }
		  ?>
    </div>
    <script src="<?php echo base_url(); ?>js/extention/choices.js"></script>
  </body>
</html>
