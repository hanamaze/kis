...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $coba->nama_coba ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('coba/read/'.$coba->id_coba),'Read'); 
				echo ' | '; 
				echo anchor(site_url('coba/update/'.$coba->id_coba),'Update'); 
				echo ' | '; 
				echo anchor(site_url('coba/delete/'.$coba->id_coba),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
