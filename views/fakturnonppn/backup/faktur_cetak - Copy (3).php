...
<p>
    ...
    <table class="table1">
      ...
      <tr>
        <td class="tb" height="186">1.</td>
        <td class="tb" style="width:400px;"><span style="width:300px;"><?php echo $uraian; ?></span></td>
        <td class="tb" style="width:150px;"><span style="width:100px;">
          <?php 
	...
	?>
        ...
        <td class="tb" style="width:150px;"><span class="tb" style="width:150px;"><?php echo $jumlah." ".$satuan; ?></span></td>
      </tr>
      <tr>
        <td class="tb" colspan="2"><span class="tb" style="text-align:center;">Terbilang: <?php echo $total_in_char." Rupiah"; ?></span></td>
