...
<html>
    ...
    <body>
		...
		<div class="form-group">
            <label for="varchar">Ppn <?php echo form_error('ppn') ?></label>
            <select name="ppn" class="form-control">
				<option value="ya" <?php if($ppn=="ya") echo "selected";?>>YA</option>
				<option value="tidak"<?php if($ppn=="tidak") echo "selected";?>>TIDAK</option>
			</select>
        </div>
		<div class="form-group">
