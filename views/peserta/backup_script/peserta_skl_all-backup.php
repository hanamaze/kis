...
<table width="644" style="width:644px;" border="0">
  ...
  <tr>
    <td>Alamat</td>
    <td style="width:512px;"> :  <?php echo md5_decrypt($pl->alamat_rumah).strlen(md5_decrypt($pl->alamat_rumah));?></td>
  </tr>
  <tr>
...
<p align="justify">Bahwa  yang bersangkutan diatas telah mengikuti pembinaan Ahli K3 Madya Konstruksi  yang diselenggarakan oleh PT. Kualitas  Indonesia Sistem (KIS) pada tanggal 26 Maret – 01 April di Hotel Heritage,  Boyolali dan dinyatakan <strong>LULUS. </strong>Adapun  Surat Keputusan Penunjukan (SKP), sertifikat, dan kartu lisensi masih dalam  proses di Kementerian Tenaga Kerja dan Transmigrasi. </p>
...
<?php if(strlen(md5_decrypt($pl->alamat_rumah)) <= 120){ ?>
  <tr>
    <td height="24" valign="top">&nbsp;</td>
  </tr>
  <?php } if(strlen(md5_decrypt($pl->alamat_rumah)) <= 60){ ?>
  <tr>
    <td height="24" valign="top">&nbsp;</td>
  </tr>
  <?php } ?>
