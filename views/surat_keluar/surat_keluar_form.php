...
<div class="box">
        ...
        <?php echo form_open("surat_keluar/update_action", array('enctype'=>'multipart/form-data')); ?>
	    ...
	    <div class="form-group">
            ...
            <input type="file" name="file" id="file" placeholder="File" value="<?php echo md5_decrypt($file);?>" required  />
        </div>
